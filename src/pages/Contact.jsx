...
function Contact() {
  ...
  const onSubmit = async (data) => {
    const userInfo = {
      access_key: "1bd2fb3e-7eb2-4076-9bb6-7573d88d4a55",
      name: data.username,
      email: data.email,
          ...
          <div className="flex flex-col md:flex-row justify-between gap-8 md:gap-16">
            <div className="w-full md:w-1/2">
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                ...
                <div>
                  <button className="w-full bg-black text-white px-4 py-2 rounded-lg hover:bg-yellow-600 duration-300">
                    Send Message
                  </button>
                </div>
              </form>
            ...
            <div className="w-full md:w-1/2">
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-center space-x-2">
                  ...
                  <span>abc@help.com</span>
                </li>
                <li className="flex items-center space-x-2">
                  <FaMapMarkedAlt className="text-green-500" />
                  <span>Adajan, Surat, India</span>
                </li>
              </ul>
            </div>
          </div>
