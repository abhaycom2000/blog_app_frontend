      ...
      <div className="flex justify-center items-center min-h-screen bg-gray-100">
        <div className="bg-white shadow-lg rounded-lg overflow-hidden max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg w-full">
          <div className="relative">
            <img src={profile?.photo?.url} alt="Admin_Photo" className='w-full h-48 object-cover'/>
            <div className="absolute inset-x-0 bottom-0 transform translate-y-1/2">
            <img src={profile?.photo?.url} alt="Admin_Photo" className='w-24 h-24 rounded-full mx-auto border-4 border-gray-700'/>
            </div>
          </div>
